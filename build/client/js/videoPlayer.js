...
var textarea = document.getElementById("video__add-comments");
...
var handlePlayClickBySpace = function handlePlayClickBySpace(e) {
  var activeElemnt = document.activeElement;
  var isTextAreaActive = activeElemnt === textarea || activeElemnt === textarea.querySelector("textarea");
  if (e.code === "Space" && !isTextAreaActive) {
    if (video.paused) {
      video.play();
    } else {
      video.pause();
...
var handleFullscreenbyFkey = function handleFullscreenbyFkey(event) {
  var fullscreen = document.fullscreenElement;
  if (event.code === "KeyF") {
    if (fullscreen) {
      document.exitFullscreen();
...
document.addEventListener("keydown", handlePlayClickBySpace);
...
document.addEventListener("keydown", handleFullscreenbyFkey);
